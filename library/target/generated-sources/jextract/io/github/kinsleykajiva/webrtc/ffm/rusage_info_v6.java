...
public class rusage_info_v6 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, webrtc_ffi_h.C_CHAR).withName("ri_uuid"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_user_time"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_system_time"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_pkg_idle_wkups"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_interrupt_wkups"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_pageins"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_wired_size"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_resident_size"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_phys_footprint"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_proc_start_abstime"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_proc_exit_abstime"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_child_user_time"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_child_system_time"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_child_pkg_idle_wkups"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_child_interrupt_wkups"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_child_pageins"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_child_elapsed_abstime"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_diskio_bytesread"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_diskio_byteswritten"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_cpu_time_qos_default"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_cpu_time_qos_maintenance"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_cpu_time_qos_background"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_cpu_time_qos_utility"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_cpu_time_qos_legacy"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_cpu_time_qos_user_initiated"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_cpu_time_qos_user_interactive"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_billed_system_time"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_serviced_system_time"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_logical_writes"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_lifetime_max_phys_footprint"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_instructions"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_cycles"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_billed_energy"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_serviced_energy"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_interval_max_phys_footprint"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_runnable_time"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_flags"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_user_ptime"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_system_ptime"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_pinstructions"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_pcycles"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_energy_nj"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_penergy_nj"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_secure_time_in_system"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_secure_ptime_in_system"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_neural_footprint"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_lifetime_max_neural_footprint"),
        webrtc_ffi_h.C_LONG_LONG.withName("ri_interval_max_neural_footprint"),
        MemoryLayout.sequenceLayout(9, webrtc_ffi_h.C_LONG_LONG).withName("ri_reserved")
    ...
    public static byte ri_uuid(MemorySegment struct, long index0) {
        return (byte)ri_uuid$ELEM_HANDLE.get(struct, ri_uuid$OFFSET, index0);
    }
    ...
    public static void ri_uuid(MemorySegment struct, long index0, byte fieldValue) {
        ri_uuid$ELEM_HANDLE.set(struct, ri_uuid$OFFSET, index0, fieldValue);
    }
    ...
    public static long ri_reserved(MemorySegment struct, long index0) {
        return (long)ri_reserved$ELEM_HANDLE.get(struct, ri_reserved$OFFSET, index0);
    }
    ...
    public static void ri_reserved(MemorySegment struct, long index0, long fieldValue) {
        ri_reserved$ELEM_HANDLE.set(struct, ri_reserved$OFFSET, index0, fieldValue);
    }
