...
public class __darwin_mcontext_avx512_64_full {
    ...
    __darwin_mcontext_avx512_64_full() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        __darwin_x86_exception_state64.layout().withName("__es"),
        __darwin_x86_thread_full_state64.layout().withName("__ss"),
        __darwin_x86_avx512_state64.layout().withName("__fs"),
