...
public class sigevent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        webrtc_ffi_h.C_INT.withName("sigev_notify"),
        webrtc_ffi_h.C_INT.withName("sigev_signo"),
        sigval.layout().withName("sigev_value"),
        webrtc_ffi_h.C_POINTER.withName("sigev_notify_function"),
        webrtc_ffi_h.C_POINTER.withName("sigev_notify_attributes")
    ).withName("sigevent");
    ...
    public final static class sigev_notify_function {
        ...
        private static final MethodHandle UP$MH = webrtc_ffi_h.upcallHandle(sigev_notify_function.Function.class, "apply", $DESC);
