...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        webrtc_ffi_h.C_POINTER.withName("__routine"),
        webrtc_ffi_h.C_POINTER.withName("__arg"),
        webrtc_ffi_h.C_POINTER.withName("__next")
    ...
    public final static class __routine {
        ...
        private static final MethodHandle UP$MH = webrtc_ffi_h.upcallHandle(__routine.Function.class, "apply", $DESC);
