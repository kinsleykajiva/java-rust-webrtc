...
public class __darwin_x86_cpmu_state64 {
    ...
    __darwin_x86_cpmu_state64() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, webrtc_ffi_h.C_LONG_LONG).withName("__ctrs")
    ...
    public static long __ctrs(MemorySegment struct, long index0) {
        return (long)__ctrs$ELEM_HANDLE.get(struct, __ctrs$OFFSET, index0);
    }
    ...
    public static void __ctrs(MemorySegment struct, long index0, long fieldValue) {
        __ctrs$ELEM_HANDLE.set(struct, __ctrs$OFFSET, index0, fieldValue);
    }
