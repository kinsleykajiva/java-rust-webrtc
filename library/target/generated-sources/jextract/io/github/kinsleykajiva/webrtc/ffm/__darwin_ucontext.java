...
public class __darwin_ucontext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        webrtc_ffi_h.C_INT.withName("uc_onstack"),
        webrtc_ffi_h.C_INT.withName("uc_sigmask"),
        __darwin_sigaltstack.layout().withName("uc_stack"),
        webrtc_ffi_h.C_POINTER.withName("uc_link"),
        webrtc_ffi_h.C_LONG.withName("uc_mcsize"),
        webrtc_ffi_h.C_POINTER.withName("uc_mcontext")
