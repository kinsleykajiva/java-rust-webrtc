...
public class __siginfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        webrtc_ffi_h.C_INT.withName("si_signo"),
        webrtc_ffi_h.C_INT.withName("si_errno"),
        webrtc_ffi_h.C_INT.withName("si_code"),
        webrtc_ffi_h.C_INT.withName("si_pid"),
        webrtc_ffi_h.C_INT.withName("si_uid"),
        webrtc_ffi_h.C_INT.withName("si_status"),
        webrtc_ffi_h.C_POINTER.withName("si_addr"),
        sigval.layout().withName("si_value"),
        webrtc_ffi_h.C_LONG.withName("si_band"),
        MemoryLayout.sequenceLayout(7, webrtc_ffi_h.C_LONG).withName("__pad")
    ).withName("__siginfo");
    ...
    public static long __pad(MemorySegment struct, long index0) {
        return (long)__pad$ELEM_HANDLE.get(struct, __pad$OFFSET, index0);
    }
