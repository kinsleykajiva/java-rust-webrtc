...
public class _opaque_pthread_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        webrtc_ffi_h.C_LONG.withName("__sig"),
        webrtc_ffi_h.C_POINTER.withName("__cleanup_stack"),
        MemoryLayout.sequenceLayout(8176, webrtc_ffi_h.C_CHAR).withName("__opaque")
