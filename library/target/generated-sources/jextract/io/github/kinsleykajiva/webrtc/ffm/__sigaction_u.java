...
public class __sigaction_u {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        webrtc_ffi_h.C_POINTER.withName("__sa_handler"),
        webrtc_ffi_h.C_POINTER.withName("__sa_sigaction")
    ...
    public final static class __sa_handler {
        ...
        private static final MethodHandle UP$MH = webrtc_ffi_h.upcallHandle(__sa_handler.Function.class, "apply", $DESC);
    ...
    public final static class __sa_sigaction {
        ...
        private static final MethodHandle UP$MH = webrtc_ffi_h.upcallHandle(__sa_sigaction.Function.class, "apply", $DESC);
