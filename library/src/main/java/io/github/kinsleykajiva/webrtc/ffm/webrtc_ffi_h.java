...
public class webrtc_ffi_h extends webrtc_ffi_h$shared {
    ...
    private static class webrtc_ffi_config_set_rtcp_forwarder {
        public static final FunctionDescriptor DESC = FunctionDescriptor.of(
            webrtc_ffi_h.C_INT,
            webrtc_ffi_h.C_POINTER,
            webrtc_ffi_h.C_INT
        ...
        public static final MemorySegment ADDR = SYMBOL_LOOKUP.findOrThrow("webrtc_ffi_config_set_rtcp_forwarder");
     ...
     * }
     */
    public static FunctionDescriptor webrtc_ffi_config_set_rtcp_forwarder$descriptor() {
        return webrtc_ffi_config_set_rtcp_forwarder.DESC;
    }
     ...
     * }
     */
    public static MethodHandle webrtc_ffi_config_set_rtcp_forwarder$handle() {
        return webrtc_ffi_config_set_rtcp_forwarder.HANDLE;
    }
     ...
     * }
     */
    public static MemorySegment webrtc_ffi_config_set_rtcp_forwarder$address() {
        return webrtc_ffi_config_set_rtcp_forwarder.ADDR;
    }
     ...
     * }
     */
    public static int webrtc_ffi_config_set_rtcp_forwarder(MemorySegment cfg, int enabled) {
        var mh$ = webrtc_ffi_config_set_rtcp_forwarder.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("webrtc_ffi_config_set_rtcp_forwarder", cfg, enabled);
            }
            return (int)mh$.invokeExact(cfg, enabled);
        } catch (Error | RuntimeException ex) {
           throw ex;
        } catch (Throwable ex$) {
           throw new AssertionError("should not reach here", ex$);
    ...
    private static class webrtc_ffi_add_transceiver_from_kind_with_encoding {
        public static final FunctionDescriptor DESC = FunctionDescriptor.of(
            webrtc_ffi_h.C_INT,
            webrtc_ffi_h.C_POINTER,
            webrtc_ffi_h.C_INT,
        ...
        public static final MemorySegment ADDR = SYMBOL_LOOKUP.findOrThrow("webrtc_ffi_add_transceiver_from_kind_with_encoding");
     ...
     * Function descriptor for:
     * {@snippet lang=c :
     * int webrtc_ffi_add_transceiver_from_kind_with_encoding(void *peer, int kind, int direction, const char *rid, uint32_t ssrc, const char *mime_type, uint32_t clock_rate, uint32_t channels)
     * }
     */
    public static FunctionDescriptor webrtc_ffi_add_transceiver_from_kind_with_encoding$descriptor() {
        return webrtc_ffi_add_transceiver_from_kind_with_encoding.DESC;
    }
     ...
     * }
     */
    public static MethodHandle webrtc_ffi_add_transceiver_from_kind_with_encoding$handle() {
        return webrtc_ffi_add_transceiver_from_kind_with_encoding.HANDLE;
    }
     ...
     * }
     */
    public static MemorySegment webrtc_ffi_add_transceiver_from_kind_with_encoding$address() {
        return webrtc_ffi_add_transceiver_from_kind_with_encoding.ADDR;
    }
     ...
     * }
     */
    public static int webrtc_ffi_add_transceiver_from_kind_with_encoding(MemorySegment peer, int kind, int direction, MemorySegment rid, int ssrc, MemorySegment mime_type, int clock_rate, int channels) {
        var mh$ = webrtc_ffi_add_transceiver_from_kind_with_encoding.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("webrtc_ffi_add_transceiver_from_kind_with_encoding", peer, kind, direction, rid, ssrc, mime_type, clock_rate, channels);
            }
            return (int)mh$.invokeExact(peer, kind, direction, rid, ssrc, mime_type, clock_rate, channels);
        } catch (Error | RuntimeException ex) {
           throw ex;
        } catch (Throwable ex$) {
           throw new AssertionError("should not reach here", ex$);
    ...
    private static class webrtc_ffi_poll_rtcp {
        public static final FunctionDescriptor DESC = FunctionDescriptor.of(
            webrtc_ffi_h.C_POINTER,
            webrtc_ffi_h.C_POINTER
        );

        public static final MemorySegment ADDR = SYMBOL_LOOKUP.findOrThrow("webrtc_ffi_poll_rtcp");
     ...
     * }
     */
    public static FunctionDescriptor webrtc_ffi_poll_rtcp$descriptor() {
        return webrtc_ffi_poll_rtcp.DESC;
    }
     ...
     * }
     */
    public static MethodHandle webrtc_ffi_poll_rtcp$handle() {
        return webrtc_ffi_poll_rtcp.HANDLE;
    }
     ...
     * }
     */
    public static MemorySegment webrtc_ffi_poll_rtcp$address() {
        return webrtc_ffi_poll_rtcp.ADDR;
    }
     ...
     * }
     */
    public static MemorySegment webrtc_ffi_poll_rtcp(MemorySegment peer) {
        var mh$ = webrtc_ffi_poll_rtcp.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("webrtc_ffi_poll_rtcp", peer);
            }
            return (MemorySegment)mh$.invokeExact(peer);
        } catch (Error | RuntimeException ex) {
           throw ex;
